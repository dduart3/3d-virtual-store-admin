...
export function ProductViewerModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-6xl h-[90vh] p-0 flex overflow-hidden">
          ...
          <Canvas
            ...
            >
              <Suspense fallback={null}>
                ...
                />
                {useOrbitControls && <OrbitControls enableZoom={true} enablePan={true} enableRotate={true} />}
        ...
        <div className="w-80 bg-background border-l p-6 overflow-y-auto">
          <h2 className="text-xl font-semibold mb-4">Configuración del modelo</h2>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-medium mb-2">Posición</h3>
              <div className="space-y-4">
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <Label htmlFor="position-x">X: {position[0].toFixed(2)}</Label>
                    <Input
                      id="position-x"
                      type="number"
                      value={position[0]}
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <Label htmlFor="position-y">Y: {position[1].toFixed(2)}</Label>
                    <Input
                      id="position-y"
                      type="number"
                      value={position[1]}
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <Label htmlFor="position-z">Z: {position[2].toFixed(2)}</Label>
                    <Input
                      id="position-z"
                      type="number"
                      value={position[2]}
            ...
            <div>
              <h3 className="text-lg font-medium mb-2">Rotación</h3>
              <div className="space-y-4">
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <Label htmlFor="rotation-x">X: {(rotation[0] * (180/Math.PI)).toFixed(0)}°</Label>
                    <Input
                      id="rotation-x"
                      type="number"
                      value={(rotation[0] * (180/Math.PI)).toFixed(0)}
                      onChange={(e) => handleRotationChange('x', parseFloat(e.target.value) * (Math.PI/180))}
                      className="w-20"
                      step={15}
                    />
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <Label htmlFor="rotation-y">Y: {(rotation[1] * (180/Math.PI)).toFixed(0)}°</Label>
                    <Input
                      id="rotation-y"
                      type="number"
                      value={(rotation[1] * (180/Math.PI)).toFixed(0)}
                      onChange={(e) => handleRotationChange('y', parseFloat(e.target.value) * (Math.PI/180))}
                      className="w-20"
                      step={15}
                    />
                  </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <Label htmlFor="rotation-z">Z: {(rotation[2] * (180/Math.PI)).toFixed(0)}°</Label>
                    <Input
                      id="rotation-z"
                      type="number"
                      value={(rotation[2] * (180/Math.PI)).toFixed(0)}
                      onChange={(e) => handleRotationChange('z', parseFloat(e.target.value) * (Math.PI/180))}
                      className="w-20"
                      step={15}
                    />
                  </div>
            ...
            <div>
              <h3 className="text-lg font-medium mb-2">Escala</h3>
              <div className="space-y-2">
                <div className="flex justify-between">
